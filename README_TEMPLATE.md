...
[![GitHub Release](https://img.shields.io/github/v/release/hojulian/microdb)](https://github.com/hojulian/microdb/releases)
[![Go Reference](https://pkg.go.dev/badge/github.com/hojulian/microdb.svg)](https://pkg.go.dev/github.com/hojulian/microdb)
[![go.mod](https://img.shields.io/github/go-mod/go-version/hojulian/microdb)](go.mod)
[![LICENSE](https://img.shields.io/github/license/hojulian/microdb)](LICENSE)
[![Build Status](https://img.shields.io/github/workflow/status/hojulian/microdb/build)](https://github.com/hojulian/microdb/actions?query=workflow%3Abuild+branch%3Amain)
[![Go Report Card](https://goreportcard.com/badge/github.com/hojulian/microdb)](https://goreportcard.com/report/github.com/hojulian/microdb)
[![Codecov](https://codecov.io/gh/hojulian/microdb/branch/main/graph/badge.svg)](https://codecov.io/gh/hojulian/microdb)
...
1. Replace all occurences of `hojulian/microdb` to `your_org/repo_name` in all files.
